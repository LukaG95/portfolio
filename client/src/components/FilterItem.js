...
const FilterItem = ({ options, currentOption, onOptionChange, isImageOption, moreLength }) => {
  ...
  return (
    ...
    >
      <div style={{ height: moreLength && "55px",zIndex: 1, fontSize: moreLength && "16px", width: moreLength && "100%", fontWeight: moreLength && "300", display: "flex", justifyContent: moreLength && "start", paddingLeft: moreLength && "10px", borderRadius: moreLength && "10px", width: moreLength && "250px" }}>
        {isImageOption ? (
